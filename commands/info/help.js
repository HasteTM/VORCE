...
module.exports = {
    ...
    run: (client, message, args) => {
        ...
        .addField('<:verified22:744610141512532008> Bot', '`guilds` `stats` `invite` `support` `botstaff` `eval` `blacklist`', true)
        .addField('<:search:744610141571383306>  Info', '`avatar` `serverinfo` `userinfo` `ping` `help`', true)
        .addField('<:crown:744928212458536972> Fun', '`meme` `rps` `love` `weather` `imdb` `coinflip` `calculate` `8ball` `urban` `shrug` `facepalm`', true)
