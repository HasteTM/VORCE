...
module.exports = {
    ...
    run: (client, message, args) => {
        ...
        .addField('<:utility:744610141411737710> | Utility','`poll` | `lockdown` | `role` | `announce` | `nuke`| `snipe`')
        ...
        .addField('<:crown:744928212458536972> | Fun', '`meme` | `rps` | `love` | `wiggle` | `weather`')
        .addField('<:music:744928360047706202> | Music', '`play` | `pause` | `skip` | `stop` | `volume` | `queue` | `remove` | `np`')
        .addField('<:arrowright:744928707847913554> | Badge Documentation','`staff` | `partner` | `bughunter` | `vbdeveloper` | `hypesquadevents` | `earlysupporter`')
        .addField('<:reddit2:744929294899478628> | Reddit', '`anime` | `dogs` | `cats` | `food` | `gaming` | `discordapp` | `programmerhumor` ')
