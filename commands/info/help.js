...
module.exports = {
    ...
    run: (client, message, args) => {
        ...
        .addField('<:arrowright:744928707847913554> | Badge Documentation','`staff` | `partner` | `bughunter` | `vbdeveloper` | `hsevents` | `earlysupporter`')
        .addField('<:reddit2:744929294899478628> | Reddit', '`anime` | `dogs` | `cats` | `food` | `gaming` | `discordapp` | `programmerhumor` | `csgo` | `fortnite` | `minecraft` | `valorant` | `rainbow6` | `terraria` | `logitech` | `corsair`')
